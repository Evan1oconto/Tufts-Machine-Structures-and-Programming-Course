...
extern void build_load_val_test(Seq_T instructions);
extern void build_add_test(Seq_T stream);
extern void build_print_six(Seq_T stream);
extern void build_mult_test(Seq_T stream);
extern void build_seg_load_store_test(Seq_T stream);
extern void build_cmove_test(Seq_T stream);
...
static struct test_info {
        ...
        { "load_val",      NULL, "Good\n", build_load_val_test },
        { "add",          NULL, ";iqSlo\n", build_add_test },
        { "mult_test",    NULL, "cilldT\n", build_mult_test },
        { "seg_load_store_test",    NULL, "23456789:;\n", build_seg_load_store_test },
        { "print-six",    NULL, "H\n", build_print_six },
        { "nand",    NULL, "@\n", build_nand_test },
        { "unmap_seg",    NULL, "A2\n", build_unmap_test },
        { "cmove",        NULL, "cd\n", build_cmove_test },
        { "load_prog",        NULL, "", build_load_prog_test },
        { "input",  "abcdefghij\n", "abcdefghij\n", build_input_test }
};
